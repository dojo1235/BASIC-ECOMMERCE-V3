...
export const getAllReviewsByProductId = asyncHandler(async (req, res) => {
  res.status(HTTP_STATUS.OK).json(buildResponse(
    await reviewService.getAllReviewsByProductId(req.params.productId, req.query),
...
export const getReviewById = asyncHandler(async (req, res) => {
  res.status(HTTP_STATUS.OK).json(buildResponse(
    await reviewService.getReviewById(req.params.reviewId),
...
export const hideReview = asyncHandler(async (req, res) => {
  res.status(HTTP_STATUS.OK).json(buildResponse(
    await reviewService.hideReview(req.params.reviewId),
